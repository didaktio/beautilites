 ...
 */
function strCapitalise(s) {
    s.replace(/^[a-z]/, v => v.toUpperCase());
}
exports.strCapitalise = strCapitalise;
/**
 * Transform a snake_case string to camelCase.
 * @param str String to transform.
 * @returns camelCase string.
 */
function strSnakeToCamel(str) {
    return str.replace(/([-_][a-z])/ig, ($1) => $1.toUpperCase().replace('-', '').replace('_', ''));
}
exports.strSnakeToCamel = strSnakeToCamel;
/**
...
exports.strCamelToSnake = strCamelToSnake;
/**
 * Transform a camelCase string to TitleCase.
 * @param str String to transform.
 * @returns TitleCase string.
 */
function strCamelToTitle(str) {
    return str.replace(/([A-Z])/g, ' $1').replace(/^./, s => s.toUpperCase());
}
exports.strCamelToTitle = strCamelToTitle;
/**
...
exports.isDomainOrURL = isDomainOrURL;
